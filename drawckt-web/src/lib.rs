...
// List of demo file names (auto-generated by build.rs)
// Demo files are served statically from /demo/ directory
...
pub fn get_demo_list() -> Result<JsValue, AppError> {
    ...
    serde_wasm_bindgen::to_value(DEMO_FILE_NAMES).map_err(AppError::SerdeWasmBindgen)
}
